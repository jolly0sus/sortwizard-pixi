...
export const LAYOUT = {
  ...
  conveyor: {
    ...
    pathInset: 50,
    // Outline of the purple belt, as half-heights along its length, mirrored
    // about centerY — the same idea as board.profile turned on its side. The
    ...
    // Colours lifted from the source art so the drawn rim matches it: deep
    // purple body, a bright lip along the top, the grey-lavender interior.
    rimColor: 0x8129a2,
    rimLight: 0xe7aaff,
    rimWidth: 15,
    // Kept for the nine-slice fallback when shape editing is not in play.
    capWidth: 420,
